class Cxmsg {
    ...
    static mostrar=(config, titulo, texto)=>{
        ...
        corpoCxmsg.setAttribute("style", estilo_corpo_Cxmsg)
        ...
        rodapeCxmsg.setAttribute("style", estilo_rodape_Cxmsg)
        areaCxmsg.appendChild(rodapeCxmsg)

        const estilo_botao_Cxmsg = 
            "background-color: "+this.cor+";"+
            "color: #fff;"+
            "padding: 10px 50px;"+
            "border-radius: 5px;"+
        ...
        if(this.tipo == "ok"){
            ...
            btn_ok.setAttribute("style", estilo_botao_Cxmsg)
            btn_ok.innerHTML = "OK"
            ...
            btn_sim.setAttribute("style", estilo_botao_Cxmsg)
            ...
            btn_nao.setAttribute("style", estilo_botao_Cxmsg)
